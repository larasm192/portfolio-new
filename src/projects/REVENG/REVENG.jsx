            ...
            <div className="relative flex flex-col lg:flex-row">
              ...
              <div className="flex items-center px-24 py-16 lg:w-3/5">
                <div className="max-w-4xl">
                  ...
                  <Summary text="Conducted a product teardown of a Braun shaver to analyse its materials, manufacturing processes, and component design. Reverse-engineered the product to propose alternative material selections aligned with the client’s performance goals."></Summary>

                  <div className="mt-6 flex flex-wrap gap-3">
                    <Badge
                      label="Tools"
                      value="Product Teardown, Ansys Granta Edupack, Market Research"
                    />
                    <Badge label="Timeframe" value="Jan – Mar 2024" />
                  </div>
